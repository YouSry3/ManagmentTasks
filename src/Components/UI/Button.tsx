...
const buttonVariants = cva(
  "flex items-center justify-center rounded-md font-medium text-white duration-300 dark:text-black disabled:bg-indigo-400 disabled:hover:bg-indigo-400 disabled:cursor-not-allowed",
  {
    ...
    danger:
      "bg-red-600 text-white hover:bg-red-700 dark:bg-[#c2344d] dark:hover:bg-red-600",
    cancel:
...
const Button = ({ type, variant, size, fullWidth, isLoading, className, children, ...rest }: ButtonProps) => {
  return (
    <button
      type={type}
